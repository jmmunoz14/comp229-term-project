...
const SurveyElement = ({ surveyTitle, id, surveyType }) => {
    ...
    function deleteSurvey() {
        ...
        axios.delete(`http://surveymeanbackend.herokuapp.com/survey/delete/${id}`, body, {
            headers: headers
        }).then(res => {
            alert("ok")
        }).catch(error => {
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td style={{ justifyContent: 'flex-end' }}><button className="btn-delete" onClick={deleteSurvey}>Delete</button></td>
